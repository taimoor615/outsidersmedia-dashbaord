...
<div class="max-w-5xl mx-auto">
    ...
    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" x-data="postForm()" class="space-y-8">
        @csrf
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <!-- Facebook -->
                <label class="relative flex flex-col items-center p-4 border-2 rounded-xl cursor-pointer transition-all hover:bg-blue-50" :class="platforms.includes('facebook') ? 'border-blue-500 bg-blue-50' : 'border-gray-200'">
                ...
                <!-- Instagram -->
                <label class="relative flex flex-col items-center p-4 border-2 rounded-xl cursor-pointer transition-all hover:bg-pink-50" :class="platforms.includes('instagram') ? 'border-pink-500 bg-pink-50' : 'border-gray-200'">
                ...
                <!-- TikTok -->
                <label class="relative flex flex-col items-center p-4 border-2 rounded-xl cursor-pointer transition-all hover:bg-gray-100" :class="platforms.includes('tiktok') ? 'border-gray-900 bg-gray-100' : 'border-gray-200'" x-show="postType !== 'carousel'">
                ...
                <!-- YouTube -->
                <label class="relative flex flex-col items-center p-4 border-2 rounded-xl cursor-pointer transition-all hover:bg-red-50" :class="platforms.includes('youtube') ? 'border-red-600 bg-red-50' : 'border-gray-200'" x-show="postType !== 'carousel'">
                ...
                <!-- Google Business -->
                <label class="relative flex flex-col items-center p-4 border-2 rounded-xl cursor-pointer transition-all hover:bg-green-50" :class="platforms.includes('google') ? 'border-green-600 bg-green-50' : 'border-gray-200'" x-show="postType !== 'carousel'">
