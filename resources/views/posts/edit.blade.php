...
<div class="max-w-5xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Edit Post</h1>
        <p class="mt-1 sm:mt-2 text-gray-600 text-sm sm:text-base">Update your social media content</p>
    </div>
    ...
    <form action="{{ route('posts.update', $post) }}" method="POST" enctype="multipart/form-data" x-data="postEditForm()" class="space-y-8">
        ...
        <div x-show="platforms.includes('google')" class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-8">
