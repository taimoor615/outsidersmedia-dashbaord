    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6" x-data="{ lightboxSrc: null }">
                ...
                @endphp
                @include('partials.video-player', ['src' => $firstMedia->stream_url, 'type' => $firstMedia->mime_type])
                @else
                @php
                    $firstMedia = $post->media->first();
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="p-4 border border-blue-200 rounded-lg bg-blue-50">
                        ...
                        @php $fb = preg_replace('/(https?:\/\/[^\s<]+)/i','<a href="$1" target="_blank" rel="noopener noreferrer" class="underline break-all">$1</a>',nl2br(e($post->facebook_message))); @endphp
                        <p class="text-sm text-blue-900 leading-relaxed">{!! $fb !!}</p>
                    </div>
                    @endif
                    ...
                    <div class="p-4 border border-pink-200 rounded-lg bg-pink-50">
                        ...
                        @php $ig = preg_replace('/(https?:\/\/[^\s<]+)/i','<a href="$1" target="_blank" rel="noopener noreferrer" class="underline break-all">$1</a>',nl2br(e($post->instagram_message))); @endphp
                        <p class="text-sm text-pink-900 leading-relaxed">{!! $ig !!}</p>
                    </div>
                    @endif
                    ...
                    <div class="p-4 border border-gray-300 rounded-lg bg-gray-50">
                        ...
                        @php $tt = preg_replace('/(https?:\/\/[^\s<]+)/i','<a href="$1" target="_blank" rel="noopener noreferrer" class="underline break-all">$1</a>',nl2br(e($post->tiktok_message))); @endphp
                        <p class="text-sm text-gray-900 leading-relaxed">{!! $tt !!}</p>
                    </div>
                    @endif
                    ...
                    <div class="p-4 border border-red-200 rounded-lg bg-red-50">
                        ...
                        @php $yt = preg_replace('/(https?:\/\/[^\s<]+)/i','<a href="$1" target="_blank" rel="noopener noreferrer" class="underline break-all">$1</a>',nl2br(e($post->youtube_message))); @endphp
                        <p class="text-sm text-red-900 leading-relaxed">{!! $yt !!}</p>
                    </div>
                    @endif
                </div>
