        ...
        <form action="{{ route('clients.update', $client) }}" method="POST" class="space-y-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div x-data="{ sharing: '{{ old('share_third_party_content', $client->share_third_party_content) ? '1' : '0' }}' }">
                        ...
                        <div x-show="sharing === '1'" x-transition x-cloak>
                            ...
                            >{{ old('preferred_sources', $client->preferred_sources) }}</textarea>
                            <p class="text-xs text-gray-400 text-right mt-1">{{ strlen(old('preferred_sources', $client->preferred_sources ?? '')) }} / 2000</p>
                        </div>
                    </div>
