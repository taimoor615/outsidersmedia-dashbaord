            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-8">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <div id="brand-tone-group" class="grid grid-cols-2 md:grid-cols-3 gap-3">
                            @foreach(['Friendly', 'Professional', 'Fun/playful', 'Inspirational', 'Bold', 'Educational', 'Minimalist', 'Other'] as $tone)
                            <label class="brand-tone-label flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                                <input
                                    type="checkbox"
                                    name="brand_tone[]"
                                    value="{{ $tone }}"
