    ...
    <div class="flex h-screen overflow-hidden">
        ...
        >
            ...
            <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <!-- Clients (View Only) -->
                <a href="{{ route('admin.clients.index') }}" class="flex items-center gap-3 px-4 py-3 text-blue-200 hover:bg-blue-800 hover:text-white rounded-xl transition-all {{ request()->routeIs('admin.clients.*') ? 'bg-blue-800 text-white shadow-lg' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Calendar -->
                <a href="#" class="flex items-center gap-3 px-4 py-3 text-blue-200 hover:bg-blue-800 hover:text-white rounded-xl transition-all">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="#" class="flex items-center gap-3 px-4 py-3 text-blue-200 hover:bg-blue-800 hover:text-white rounded-xl transition-all">
                    ...
                    <span class="ml-auto px-2 py-1 bg-orange-500 text-white text-xs font-bold rounded-full">3</span>
                </a>
