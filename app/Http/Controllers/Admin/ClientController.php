...
class ClientController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'email'                      => 'required|email:rfc,dns|max:254|unique:clients,email',
            'website_url'                => 'nullable|url|max:500',
            'location'                   => 'nullable|string|max:255',
            'business_description'       => 'nullable|string|max:5000',
            'unique_value'               => 'nullable|string|max:3000',
            ...
            'content_to_avoid'           => 'nullable|string|max:3000',
            ...
            'brand_assets_link'          => 'nullable|url|max:500',
    ...
    public function update(Request $request, Client $client)
    {
        $validated = $request->validate([
            'name'                       => 'required|string|min:2|max:255',
            'email'                      => 'required|email:rfc,dns|max:254|unique:clients,email,' . $client->id,
            'website_url'                => 'nullable|url|max:500',
            'location'                   => 'nullable|string|max:255',
            'business_description'       => 'nullable|string|max:5000',
            'unique_value'               => 'nullable|string|max:3000',
